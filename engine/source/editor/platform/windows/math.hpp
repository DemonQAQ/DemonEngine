...
#ifndef DEMON_ENGINE_MATH_HPP
#define DEMON_ENGINE_MATH_HPP
...
void
BuildPerspectiveFovLHMatrix(float *matrix, float fieldOfView, float screenAspect, float screenNear, float screenDepth)
{
