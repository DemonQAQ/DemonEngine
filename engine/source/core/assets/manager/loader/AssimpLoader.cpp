                                       ...
                                       std::vector<std::shared_ptr<base::Material>> &materials)
{
    ...
    for (unsigned int i = 0; i < aiNode->mNumMeshes; i++)
    {
        ...
        auto newMesh = processMesh(mesh, meshName, meshPathIdentifier, globalTransform);
...
assets::AssimpLoader::processMesh(aiMesh *mesh, const std::string &meshName, const std::string &rootPath,
